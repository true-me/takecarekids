...
- (id)initWithFrame:(CGRect)frame arrowImageName:(NSString *)arrow textColor:(UIColor *)textColor  {
    ...
    if (self) {
        ...
        UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake(0.0f, 30.0f -30.0f, self.frame.size.width, 20.0f)];
		...
		label = [[UILabel alloc] initWithFrame:CGRectMake(0.0f, 48.0f -30.0f, self.frame.size.width, 20.0f)];
		label.autoresizingMask = UIViewAutoresizingFlexibleWidth;
		...
		layer.frame = CGRectMake(25.0f, 65.0f-60.0f, 30.0f, 55.0f);
		...
		view.frame = CGRectMake(25.0f, 38.0f-30.0f, 20.0f, 20.0f);
...
//        
/////////
//        UIView *bView = [[[UIView alloc] initWithFrame:CGRectMake(90, 11, 140, 30)] autorelease];
//        NSUserDefaults *ud = [NSUserDefaults standardUserDefaults];
//        NSString *navColor = [ud objectForKey:@"navColor"];
...
- (void)egoRefreshScrollViewDidScroll:(UIScrollView *)scrollView {
    ...
    if (_state == EGOOFooterPullRefreshLoading) {
        ...
        if (_state == EGOOFooterPullRefreshPulling && scrollView.contentOffset.y + (scrollView.frame.size.height) < scrollView.contentSize.height + RefreshViewHight && scrollView.contentOffset.y > 0.0f && !_loading) {
            [self setState:EGOOFooterPullRefreshNormal];
        } else if (_state == EGOOFooterPullRefreshNormal && scrollView.contentOffset.y + (scrollView.frame.size.height) > scrollView.contentSize.height + RefreshViewHight  && !_loading) {
