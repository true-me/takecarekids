...
@property (nonatomic,getter = isfooterEnable) BOOL footerEnable;
@property (nonatomic,getter = isHeaderEnable) BOOL headerEnable;
...
@optional
//Implement this method if footerEnable is false
