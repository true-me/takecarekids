...
//		label.textColor = textColor;
        //修改字体样式;    马文涛 2013/01/27
        label.font = [UIFont fontWithName:@"STHeitiTC-Medium" size:10.0f];
        UIColor *color = [[UIColor alloc] initWithRed:0.5 green:0.5 blue:0.5 alpha:0.8];
		...
		layer.frame = CGRectMake(65.0f, frame.size.height - 59.0f, 30.0f, 55.0f);
...
- (void)setState:(EGOPullRefreshState)aState{
	...
	switch (aState) {
		case EGOOPullRefreshPulling:
			...
			_statusLabel.text = NSLocalizedString(@"释放刷新数据...", @"释放刷新状态");
			[CATransaction begin];
		...
		case EGOOPullRefreshLoading:
			...
			_statusLabel.text = NSLocalizedString(@"正在加载...", @"加载状态");
